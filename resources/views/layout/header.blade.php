...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/vendors/eduact-icons/style.css') }}" />
    ...
    <!-- template styles -->
    <link rel="stylesheet" href="{{ asset('assets/css/eduact.css') }}" />
</head>
...
<body class="custom-cursor">
    ...
    <div class="custom-cursor__cursor-two"></div>
        ...
        <div class="preloader">
            <div class="preloader__image" style="background-image: url(assets/images/islamibertalenta.png);"></div>
        </div>
    <!-- /.preloader -->
