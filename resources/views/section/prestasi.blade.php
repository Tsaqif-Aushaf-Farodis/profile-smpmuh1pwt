<!-- Prestasi Start -->
<section class="blog-page" id="{{ Str::before($section->type, '_template') }}">
    <div class="container">
        <div class="section-title text-center">
            ...
            <h2 class="section-title__title">{{ $prestasi[0]['title'] }}</h2>
        </div><!-- section-title -->
        
        <div class="blog-page__carousel eduact-owl__carousel eduact-owl__dots owl-theme owl-carousel" data-owl-options='{
    "items": 3,
    "margin": 30,
    "smartSpeed": 700,
    "loop":true,
