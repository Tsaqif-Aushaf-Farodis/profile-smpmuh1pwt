  <!-- Team Start -->
  <section class="team-one" id="{{ Str::before($section->type, '_template') }}" style="background-image: url(assets/images/shapes/team-bg-1.png);" >
    <div class="container">
        <div class="section-title text-center wow fadeInUp" data-wow-delay="100ms">
            ...
            <!-- <h2 class="section-title__title">Tenaga Pengajar Kami</h2> -->
        </div><!-- section-title -->
        <div class="team-page__carousel eduact-owl__carousel eduact-owl__dots owl-theme owl-carousel" data-owl-options='{
            "items": 3,
            "margin": 30,
            "smartSpeed": 700,
            "loop":true,
                    ...
                    <div class="item">
                        <div class="team-two__item">
                            <div class="team-two__image">
                                <img src="{{ asset('storage/' . $item->photo) }}" alt="eduact">
                            </div><!-- /.team-image -->
